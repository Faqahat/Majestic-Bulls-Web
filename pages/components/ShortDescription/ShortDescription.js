...
function ShortDescription() {
	return (
		<div className="bg-black">
			<p className=" text-white text-2xl  md:text-4xl lg:text-4xl xl:text-4xl  font-bold  md:mt-16  md:leading-normal max-w-[1410px] w-full px-5 mx-auto  pt-12 pb-6 font-Abreto text-left">
			...
			<p className=" sm:text-xs md:text-xl  md:mb-10  text-white md:leading-normal max-w-[1410px] w-full px-5 mx-auto  pb-12 pt-6 font-Abreto text-left">
