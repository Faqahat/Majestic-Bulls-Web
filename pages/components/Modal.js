					...
					<div className="` my-auto max-w-[868px] w-full mx-auto   bg-white/20 backdrop-blur-xl pt-8 md:px-9 p-6 md:pb-9">
						...
						<div className="flex flex-col sm:flex-row justify-between items-center gap-3">
							<div className="max-w-md w-full text-white">
								<h1
									className="text-2xl sm:text-2xl xl:text-[30px] font-normal font-nexa text-white mb-6 md:mb-9"
									style={{ textShadow: '10px 5px 1px rgba(0, 0, 0, 0.31)' }}
								>
									{info.name}
								</h1>
								<p className="text-justify text-base lg:text-l 2xl:text-l 2xl:leading-tight font-nexa font-light">
									{info.description}
								</p>
							</div>
						...
						<div className="flex flex-col sm:flex-row justify-between items-center gap-5 my-8 xl:my-10">
							<div className="max-w-[275px] w-full text-white">
								...
								<p className="text-right text-xl  text-white font-light mt-1 md:mt-4">
