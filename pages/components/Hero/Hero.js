		...
		<header id="intro" className=" scroll-mt-28 xl:scroll-mt-40 relative">
			<span className="aspect-[16/12] md:aspect-auto md:h-screen object-cover w-full">
				...
				<div className="flex items-center justify-center absolute top-1/2 left-1/2 transform p-10 -translate-x-1/2 -translate-y-1/2 gap-5 group">
					<button
						className="btn-play text-white w-16 h-16 opacity-0 invisible group-hover:visible group-hover:opacity-100 flex items-center justify-center transition-all duration-200 rounded-full bg-black"
						open
					>
						<svg
					...
					<button
						className="btn-voice group text-white w-16 h-16 opacity-0 invisible group-hover:visible group-hover:opacity-100 flex items-center justify-center transition-all duration-200 rounded-full bg-black"
						open
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
