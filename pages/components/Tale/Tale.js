...
function Tale() {
	return (
		<section
			id="tale"
			class="w-full h-full lg:h-[1150px] relative scroll-mt-28 xl:scroll-mt-40"
		>
			<Image
				src={taleImg}
				alt="img"
				class="w-full aspect-video md:aspect-auto md:h-full object-cover md:object-right"
			/>
			<div class="max-w-full lg:max-w-[860px] w-full bg-black ml-auto p-5 sm:p-14 static lg:absolute top-20 right-20">
				<div class="flex items-center gap-5">
					<h2 class="text-3xl md:text-[55px] text-white leading-[70px] font-light">
						// <span class="font-bold text-white">The</span> Tale
					</h2>
					<Image
						src={taleHeader}
						alt="img"
						class="w-16 md:w-auto h-auto object-contain"
					/>
				</div>
				<p
					class="text-white md:text-2xl text-base leading-relaxed md:leading-[50px] font-bold pr-3 md:pr-12 font-nexa h-[350px] md:h-[770px] overflow-auto"
					id="scrollbar-custom"
				>
