...
function Navigation() {
	...
	return (
		<nav
			id="navbar"
			className="px-5 w-full mx-auto h-[100px] xl:h-[120px] fixed bg-white border-b-2 border-black/20 xl:border-none z-50 drop-shadow-lg"
		>
				...
				<div className="navbar w-auto">
					<ul className="flex flex-col desktop:flex-row items-center justify-center desktop:justify-between gap-4 w-full">
						...
						<li>
							...
							<a href="#thedesign" className={roadmap ?"text-link active" :"text-link hover:transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-[#000000] hover:text-[#ffffff] duration-300" }  onClick={()=>{setIntro(false);setTale(false);setMajestic(false);setAplha(false);setRoadmap(true);setCouncil(false)}}>
