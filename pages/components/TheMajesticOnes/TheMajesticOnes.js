	...
	return (
		...
		>
			...
			<div className="w-full grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] md:grid-cols-3 lg:grid-cols-4 gap-6 xl:gap-[62px]">
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b2)}}
						/>
					</a>
				</div>
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b3)}}
						/>
					</a>
				</div>
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b4)}}
						/>
					</a>
				</div>
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b6)}}
						/>
					</a>
				</div>
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b7)}}
						/>
					</a>
				</div>
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b9)}}
						/>
					</a>
				</div>
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b10)}}
						/>
					</a>
				</div>
				...
				<div className="relative hover:transform hover:-translate-y-2 transition-all duration-300">
					<a href="#popup" className="open-popup inline-block">
						...
						<Image
							...
							height="500"
							width="500"
							onClick={() => {setShowModal(true);setImgName(b12)}}
						/>
					</a>
				</div>
				...
				{showModal ? (
					<>
				<div className="` absolute w-full  h-screen overflow-auto bg-black/70 z-50 p-5 md:p-10 grid items-center justify-center" id="popup">
          <div className="` my-auto max-w-[868px] w-full mx-auto border-[10px] border-black/40 bg-white/20 backdrop-blur-3xl pt-8 md:px-9 p-6 md:pb-9">
            <h2 className="text-white text-2xl text-center font-nomral font-nexa sm:text-3xl lg:text-[42px] mb-9">The Majestic Ones</h2>
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
              <div className="max-w-md w-full text-white">
                <h1 className="text-3xl sm:text-4xl 2xl:text-[67px] font-normal font-nexa text-white mb-6 md:mb-12" style={{textShadow: "10px 5px 1px rgba(0, 0, 0, 0.31)"}}>The Thunder</h1>
                <p className="text-base lg:text-xl 2xl:text-2xl 2xl:leading-tight font-nexa font-light">The Thunder is said to have power of 10 Million Thunders. In Times of war The Thunder can cause havoc on enemies by Creating Thunder Storms. The History has proven that The Thunder is one of the most powerful Bull with ability to control of weather at tip of its stick The Thunder is Truly “Majestic”</p>
              </div>
              <div className="max-w-xs w-full order-first sm:order-none">
                <Image src={imgName} alt="Thunder" className="object-contain w-3/5 sm:w-full block mx-auto sm:mx-0" />
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-5 my-8 xl:my-14">
              <div className="max-w-[275px] w-full text-white">
                <p className="text-base text-white/40 before:content-[''] before:h-px before:w-full before:bg-white/40 grid grid-cols-[1fr_max-content] items-center gap-2">Special Power</p>
                <p className="text-right text-xl lg:text-2xl text-white font-light mt-4 md:mt-7">Thunder ⚡️</p>
              </div>
              <div className="max-w-[300px] w-full">
                <button className="bg-white flex items-center justify-between gap-3 text-black text-lg md:text-2xl font-bold font-nexa py-2 px-4 w-full border border-[#707070] shadow-normal hover:shadow-none transition-all duration-300">
                  View on OpenSea
                  <Image src={opensea} alt="" className="w-8 h-auto object-contain" />
                </button>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center gap-4">
              <button>
                <Image src={af} alt="" className="w-8 h-8 md:w-auto md:h-auto" />
              </button>
              <button>
                <Image src={ar} alt="" className="w-8 h-8 md:w-auto md:h-auto" />
              </button>
            </div>

            <button className="popup-close absolute top-5 right-5 text-white">
              <svg className="w-6 h-6 md:w-9 md:h-9 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" onClick={() => setShowModal(false)}>
                <path
